function Flbp=xu_lbpFeats(Rimg,mapping,mapping2)
...
%% b - LNP features
rr2=4;
[LNP_S1,LNP_M1]=xu_LNP(Rimg,rr2,mapping2,'x','mins');   %30
[LNP_S2,LNP_M2]=xu_LNP(Rimg,rr2,mapping2,'x','mids');   %30
[LNP_S3,LNP_M3]=xu_LNP(Rimg,rr2,mapping2,'x','maxs');   %30
...
%% c - RBP features
[RBP_S1,RBP_M1]=xu_RBP(Rimg,1:rr2,0,'x','mins'); % 48
[RBP_S2,RBP_M2]=xu_RBP(Rimg,1:rr2,0,'x','mids'); % 48
[RBP_S3,RBP_M3]=xu_RBP(Rimg,1:rr2,0,'x','maxs'); % 48
