...
% from the authors.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%# Usage: choose all the image tiles from whole glass biopy satisfying pp & ppt two thresholds
function [top_left2,bottom_right2]=xu_SelectImageTiles_I(bwTissue,bwHimg,pp,ppt,tileSize,augmentStep)
