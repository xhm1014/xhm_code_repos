function [TF_3D,TF_2D]=xu_texturalFeats_SLBP_extension_II(top_left,bottom_right,slidePtr,levelforRead,magFine,magCoarse,magToUseAbove)
...
if nargin==6
    for tind=1:size(top_left,1)
        ...
        for idxLbpRadius = 1 : length(lbpRadiusSet)
            ...
            [f00_3D,f00_2D]=xu_SLBP_median(double(Rimg),lbpRadius,lbpPoints,mapping);   %
            [f01_3D,f01_2D]=xu_SLBP_std(double(Rimg),lbpRadius,lbpPoints,mapping);
